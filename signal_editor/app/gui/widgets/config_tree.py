...
#             editor = qfw.ColorPickerButton(
#                 data, index.data(QtCore.Qt.ItemDataRole.DisplayRole), parent, enableAlpha=True
#             )
#         else:
...
#     def setModelData(
#         self, editor: QtWidgets.QWidget, model: QtCore.QAbstractItemModel, index: Index
#     ) -> None:
#         if isinstance(editor, qfw.CheckBox):
...
#             model.setData(
#                 index, RateComputationMethod[editor.currentText()], QtCore.Qt.ItemDataRole.UserRole
#             )
#         elif isinstance(editor, qfw.ColorPickerButton):
#             model.setData(
#                 index,
#                 editor.color.name(QtGui.QColor.NameFormat.HexArgb),
#                 QtCore.Qt.ItemDataRole.EditRole,
#             )
#             model.setData(
#                 index,
#                 editor.color,
#                 QtCore.Qt.ItemDataRole.UserRole | QtCore.Qt.ItemDataRole.BackgroundRole,
#             )
#         else:
...
#         self._config = Config.from_qsettings()
