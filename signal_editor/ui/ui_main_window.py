...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/filter", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/icons/cross", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon17 = QIcon()
        icon17.addFile(u":/icons/target", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon20 = QIcon()
        icon20.addFile(u":/icons/user_guide", QSize(), QIcon.Normal, QIcon.Off)
        self.action_show_user_guide.setIcon(icon20)
        ...
        icon21 = QIcon()
        icon21.addFile(u":/icons/info", QSize(), QIcon.Normal, QIcon.Off)
        self.action_about_app.setIcon(icon21)
        ...
        icon22 = QIcon()
        icon22.addFile(u":/icons/section_remove", QSize(), QIcon.Normal, QIcon.Off)
        self.action_delete_section.setIcon(icon22)
