...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/create", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/icons/binoculars", QSize(), QIcon.Normal, QIcon.Off)
        self.action_show_section_overview.setIcon(icon14)
        self.action_show_section_overview.setMenuRole(QAction.NoRole)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/icons/table_import", QSize(), QIcon.Normal, QIcon.Off)
