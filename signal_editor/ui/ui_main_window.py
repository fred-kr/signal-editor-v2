...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon20 = QIcon()
        icon20.addFile(u":/icons/table_import", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_load_data.setIcon(icon20)
        ...
        self.splitter_3 = QSplitter(self.container_file_information)
        ...
        self.gridLayout.addWidget(self.splitter_3, 5, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.btn_open_file, 2, 0, 1, 3)
...
#if QT_CONFIG(tooltip)
        self.search_list_widget_recent_files.setToolTip(QCoreApplication.translate("MainWindow", u"Double-click a file to open it", None))
#endif // QT_CONFIG(tooltip)
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:11pt; font-weight:700;\">Metadata (Detailed)</span></p></body></html>", None))
