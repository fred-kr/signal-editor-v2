...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/new_section", QSize(), QIcon.Normal, QIcon.Off)
        self.action_create_new_section.setIcon(icon10)
        self.action_create_new_section.setMenuRole(QAction.NoRole)
        ...
        self.action_show_filter_inputs.setCheckable(True)
        icon11 = QIcon()
        icon11.addFile(u":/icons/view_app_monitor", QSize(), QIcon.Normal, QIcon.Off)
        self.action_show_filter_inputs.setIcon(icon11)
        self.action_show_filter_inputs.setMenuRole(QAction.NoRole)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/toggle_autoscale", QSize(), QIcon.Normal, QIcon.Off)
        self.action_toggle_auto_scaling.setIcon(icon12)
        self.action_toggle_auto_scaling.setMenuRole(QAction.NoRole)
        self.action_confirm_section = QAction(MainWindow)
        self.action_confirm_section.setObjectName(u"action_confirm_section")
        icon13 = QIcon()
        icon13.addFile(u":/icons/tick_button", QSize(), QIcon.Normal, QIcon.Off)
        self.action_confirm_section.setIcon(icon13)
        self.action_confirm_section.setMenuRole(QAction.NoRole)
        ...
        self.action_cancel_section.setMenuRole(QAction.NoRole)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/icons/table_import", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_load_data.setIcon(icon14)
...
#if QT_CONFIG(tooltip)
        self.action_create_new_section.setToolTip(QCoreApplication.translate("MainWindow", u"Select a section to edit", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.action_confirm_section.setToolTip(QCoreApplication.translate("MainWindow", u"Create new section", None))
#endif // QT_CONFIG(tooltip)
        self.action_cancel_section.setText(QCoreApplication.translate("MainWindow", u"Cancel Section", None))
#if QT_CONFIG(tooltip)
        self.action_cancel_section.setToolTip(QCoreApplication.translate("MainWindow", u"Cancel selection of new section", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
