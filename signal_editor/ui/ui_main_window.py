...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/tick_button", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/icons/delete", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon18 = QIcon()
        icon18.addFile(u":/icons/list_view", QSize(), QIcon.Normal, QIcon.Off)
        self.action_show_section_list.setIcon(icon18)
        ...
        icon19 = QIcon()
        icon19.addFile(u":/icons/report", QSize(), QIcon.Normal, QIcon.Off)
        self.action_show_status_log.setIcon(icon19)
        ...
        icon20 = QIcon()
        icon20.addFile(u":/icons/whats_this", QSize(), QIcon.Normal, QIcon.Off)
        self.action_toggle_whats_this_mode.setIcon(icon20)
        self.action_toggle_whats_this_mode.setMenuRole(QAction.MenuRole.NoRole)
        self.action_show_user_guide = QAction(MainWindow)
        self.action_show_user_guide.setObjectName(u"action_show_user_guide")
        icon21 = QIcon()
        icon21.addFile(u":/icons/user_guide", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon22 = QIcon()
        icon22.addFile(u":/icons/info", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.label_7 = QLabel(self.container_file_information)
        ...
        self.gridLayout.addWidget(self.line_edit_active_file, 2, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.grp_box_required_info, 3, 0, 1, 3)
        ...
        self.btn_close_file.setMinimumSize(QSize(0, 48))
        self.btn_close_file.setIcon(icon8)

        self.gridLayout.addWidget(self.btn_close_file, 4, 2, 1, 1)

        self.splitter_2 = QSplitter(self.container_file_information)
        ...
        self.collapsible_frame = QCollapsible(self.widget_2)
        ...
        self.verticalLayout.addWidget(self.collapsible_frame)

        self.splitter_2.addWidget(self.widget_2)

        self.gridLayout.addWidget(self.splitter_2, 5, 0, 1, 3)
        ...
        self.tool_bar_help = QToolBar(MainWindow)
        self.tool_bar_help.setObjectName(u"tool_bar_help")
        self.tool_bar_help.setEnabled(True)
        self.tool_bar_help.setMovable(False)
        self.tool_bar_help.setAllowedAreas(Qt.ToolBarArea.TopToolBarArea)
        self.tool_bar_help.setFloatable(False)
        MainWindow.addToolBar(Qt.ToolBarArea.TopToolBarArea, self.tool_bar_help)
        ...
        self.menuHelp.addAction(self.action_toggle_whats_this_mode)
        ...
        self.tool_bar_help.addAction(self.action_show_user_guide)
        self.tool_bar_help.addAction(self.action_toggle_whats_this_mode)
    ...
    def retranslateUi(self, MainWindow):
...
#endif // QT_CONFIG(shortcut)
        self.action_toggle_whats_this_mode.setText(QCoreApplication.translate("MainWindow", u"What's This?", None))
#if QT_CONFIG(tooltip)
        self.action_toggle_whats_this_mode.setToolTip(QCoreApplication.translate("MainWindow", u"Toggle 'What's This?' mode", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.action_toggle_whats_this_mode.setShortcut(QCoreApplication.translate("MainWindow", u"Shift+F1", None))
#endif // QT_CONFIG(shortcut)
        ...
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"Active File:", None))
        ...
        self.tool_bar_help.setWindowTitle(QCoreApplication.translate("MainWindow", u"User Guide + Documentation Toolbar", None))
    # retranslateUi
